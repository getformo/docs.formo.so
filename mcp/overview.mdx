...
icon: robot
description: 'Connect Cursor, Claude Desktop, and other AI tools to your Formo analytics data using the Model Context Protocol server for natural language queries.'
---
...
**Supported clients:** Claude Desktop, Cursor, Claude Code, Windsurf, VS Code, Codex, and any client that supports HTTP or stdio MCP transports. You can also chat with your analytics data in Telegram — see the [Telegram Bot](/mcp/telegram-bot).
