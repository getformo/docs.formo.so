...
| `test_alert` | Send a test delivery to an alert's webhook recipients (makes real HTTP requests) | `alerts:write` |
...
| `list_contract_recommendations` | Recommend recently-interacted contracts that are not yet tracked | `contracts:read` |
