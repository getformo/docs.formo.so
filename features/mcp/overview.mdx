...
<Tabs>
  <Tab title="Claude Desktop">
    ...
    <Tab title="Cursor">
    One-click to install: [![Install MCP Server](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=formo&config=eyJjb21tYW5kIjoibnB4IG1jcC1yZW1vdGUgaHR0cHM6Ly9hcGkuZm9ybW8uc28vdjAvbWNwLyAtLWhlYWRlciBBdXRob3JpemF0aW9uOiBCZWFyZXIgWU9VUl9BUElfS0VZIn0%3D)
