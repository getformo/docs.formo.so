...
Events can be a wide range of interactions. For example, every time a user connects a wallet or performs an onchain transaction on your dapp, there are details which describe that action the moment it happens. 
