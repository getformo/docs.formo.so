...
Each user is automatically <a href="/features/wallet-intelligence/wallet-labels">labelled</a> and grouped into <a href="/features/wallet-intelligence/segmentation">segments</a> such as 'New User' or 'Returning User'. 
