...
- Volume, revenue, and points on your app
...
| **Linked Addresses** | Other wallet addresses that share a session or user ID with this one. See the **Clusters** tab on the Users page for the full multi-wallet group. |
