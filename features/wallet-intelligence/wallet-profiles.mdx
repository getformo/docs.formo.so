...
See **detailed information about each user**. Turn anonymous wallets into high-value users and track usage of specific, high-value wallets on your dapp.
...
See each user's **Wallet Reputation Score.** This score is calculated from each users's onchain footprint, wallet labels, attestations, and proof-of-personhood to segment and rank your users.
