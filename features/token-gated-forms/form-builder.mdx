...
## Quick Start: Create Your First Token-Gated Form
...
- **Zapier** - Send responses to Slack, Notion, Google Sheets, etc.
...
<CardGroup cols={2}>
  ...
  <Card title="Zapier Integration" icon="plug" href="/features/token-gated-forms/zapier">
    Automate workflows with form responses
  </Card>
  <Card title="Forms API" icon="code" href="/api-reference/forms/list">
