...
Go to your workspace settings page with the 'Settings' link on the top left workspace dropdown to find your API page:

<Frame caption="Find your API Key in your workspace settings page.">
    <img src="/images/zapier-0.png" alt="Token Gated Forms Zapier" />
</Frame>

Create an API Key with the Forms API 'Read' scope and copy it.
