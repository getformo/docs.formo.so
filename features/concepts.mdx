...
title: 'Core Concepts'
icon: lightbulb
description: 'Learn about the core concepts of Formo: Events, Users, and Properties. Get unified analytics and attribution with powerful event-based analytics.'
---
