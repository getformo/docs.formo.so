...
## Quick Start: Create Your First Funnel
...
<Tip>Steps must happen in order. Formo tracks users who complete step 1, then step 2, then step 3 (in sequence).</Tip>
...
Track minting journey:

| Step | Event | Typical conversion |
|------|-------|-------------------|
| 1 | Visit mint page | 100% (baseline) |
| 2 | Connect wallet | 50-70% |
| 3 | Mint NFT | 30-50% |
