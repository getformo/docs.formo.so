...
## Quick Start: Analyze Traffic Sources

Growth Analytics helps you understand where your users come from and which channels drive the most value. This guide walks you through analyzing traffic sources and optimizing acquisition.

### Step 1: Open Growth Analytics

1. Go to the [Formo Dashboard](https://app.formo.so)
2. Select your project
3. Click **Growth** in the left navigation
...
<CardGroup cols={2}>
  <Card title="Attribution Deep Dive" icon="route" href="/data/attribution">
