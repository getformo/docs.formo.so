...
To track full referer URLs (instead of just the domain), you need to make sure your site has the correct `Referer-Policy` header set.
...
<Tabs>
  ...
  <Tab icon="code" title="HTML">
    You can set the referer policy using a meta tag in the `<head>` section of your HTML:
