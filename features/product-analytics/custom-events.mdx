...
Formo also supports `revenue` and `points` tracking. [Learn more about tracking revenue](/data/events/track#properties).
...
Custom events integrates with Formo's [Wallet Intelligence](/features/wallet-intelligence) to give you a complete picture of each user's journey.
[Funnels](/features/product-analytics/funnels) help you understand how your users interact with your dapp.