...
## Quick Start: Analyze User Retention
...
<Tip>For dApps, `transaction` retention is usually the most meaningful metric—it shows who's actually using your protocol.</Tip>
...
### Retention benchmarks for dApps

| dApp Type | Week 1 | Week 4 | Week 8 |
|-----------|--------|--------|--------|
