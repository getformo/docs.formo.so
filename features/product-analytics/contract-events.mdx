...
description: 'Add smart contract addresses to ingest and decode onchain events like swaps, transfers, and mints in real time across supported EVM chains.'
---
...
4. Toggle on the events you want to track from the list (up to 10 events per contract)

<Note>Event ingestion requires a paid plan. On the Free plan, you can still add a contract to decode transactions, but event selection is locked until you upgrade.</Note>
