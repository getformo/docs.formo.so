...
- **Save as a custom chart**: Turn any query into a reusable visualization on your [Chartbuilder](/features/product-analytics/charts) dashboard — choose from line, bar, pie, table, and more.
...
1. On the [Chartbuilder](/features/product-analytics/charts) page, select an existing board or create a new one
