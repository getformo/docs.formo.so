...
1. Click the **Ask AI** button (or press `Cmd+K`)
...
<Tip>Use autocomplete (`Ctrl+Space`) to see available tables and columns. See the [Data Schema](/data/schema) for full documentation.</Tip>
