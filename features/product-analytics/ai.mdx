...
Agentic analytics for onchain apps is now available on Formo! You can use **Ask AI** (the AI assistant) to help you explore your data and surface hidden insights.
...
<CardGroup cols={2}>
  <Card title="How to use Ask AI" icon="message-bot" href="/guides/ask-ai">
