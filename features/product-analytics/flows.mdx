...
| **Contract event** | Behavior after an onchain action |
...
3. Set **Events per step** (2 to 100; default 20), the number of distinct events shown per step, most frequent first, before the rest are grouped into "Others" at the bottom of the column
