...
User flow analysis (also known as [the Sankey diagram](https://en.wikipedia.org/wiki/Sankey_diagram)) identifies the most frequent paths taken by users to or from any event. 
