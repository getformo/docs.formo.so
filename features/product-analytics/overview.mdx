...
To enable cross-subdomain analytics, simply use your root domain when adding your project in the Formo dashboard (see the Add Project screen). The Formo SDK will handle all cookie and session management for you, ensuring seamless analytics across your entire domain ecosystem.
...
- Complete analytics: Get holistic data about user behavior across your full domain
