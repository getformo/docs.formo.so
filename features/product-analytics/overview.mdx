...
description: 'Track the full user journey from acquisition to onchain conversion and retention with unified product analytics for DeFi and crypto applications.'
---
...
Once you install the Formo SDK, **it automatically tracks [events](/data/events/overview)** (including page views, wallet connects, and transactions) without the need for manual tracking or custom code.
...
<AccordionGroup>
  ...
  <Accordion title="Can I write SQL queries against my analytics data?">
    Yes. Use the [Explorer](/features/product-analytics/explore) to run SQL queries directly against your analytics data. You can also use the [Analytics API](/api/query) or connect [BI tools](/data/bi) like Metabase or Grafana.
  </Accordion>
</AccordionGroup>
