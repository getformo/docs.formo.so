...
## Quick Start: Set Up Product Analytics
...
| **Activity** | Real-time event stream with filters |
| **Growth** | Traffic sources, referrers, and geographic breakdown |
| **Retention** | Week-over-week cohort retention |
...
<CardGroup cols={2}>
  ...
  <Card title="Set Up Alerts" icon="bell" href="/features/product-analytics/alerts">
    Get notified when whales visit your app
  </Card>
  <Card title="Build Custom Charts" icon="chart-line" href="/features/product-analytics/charts">
