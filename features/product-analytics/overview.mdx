...
<AccordionGroup>
  ...
  <Accordion title="Can I track users across my marketing site and my dApp?">
    Yes. Enable cross-subdomain tracking by setting `crossSubdomainCookies: true` in the SDK configuration. This shares visitor identity across all subdomains of your root domain. See the [Web SDK documentation](/sdks/web#cross-subdomain-tracking) for setup instructions.
  </Accordion>
