...
<AccordionGroup>
  ...
  <Accordion title="Can I track users across my marketing site and my dApp?">
    Yes. Formo supports cross-subdomain analytics out of the box. Use your root domain when adding your project in the dashboard, and the SDK handles identity resolution and session management across subdomains.
  </Accordion>
