...
9. **Organic Search** - unpaid traffic from search engines (`utm_medium=organic` or referrer matches a search domain with no paid signal).
10. **Organic Social** - unpaid traffic from social platforms.
11. **Organic Video** - unpaid traffic from video platforms.
12. **Referrers** - any other non-empty referrer not matched above.
