...
Each API endpoint that supports agent access documents its gateway URL, price, and SDK examples under its **Authentication** section. See:

<Card title="Get Profile" icon="user" href="/api/profiles/get#authentication">
  Gateway URLs and x402 / MPP SDK examples for the Profiles endpoint.
</Card>
