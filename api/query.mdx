...
<Frame>
	<img src="/images/query-api-diagram.png" alt="Analytics API architecture diagram showing your service sending SQL queries to the Analytics API and receiving data from the Data Warehouse" />
</Frame>
