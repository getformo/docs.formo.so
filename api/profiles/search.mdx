...
|----------|-------------|---------|
| `equals` | Equals | `{"field": "users.device", "op": "equals", "value": "Desktop"}` |
| `notEquals` | Not equals | `{"field": "users.os", "op": "notEquals", "value": "Windows"}` |
| `greater` | Greater than | `{"field": "users.net_worth_usd", "op": "greater", "value": 1000}` |
| `greaterOrEqual` | Greater than or equal | `{"field": "users.volume", "op": "greaterOrEqual", "value": 100}` |
| `less` | Less than | `{"field": "users.net_worth_usd", "op": "less", "value": 50000}` |
| `lessOrEqual` | Less than or equal | `{"field": "chains.1.balance", "op": "lessOrEqual", "value": 10000}` |
| `in` | In array | `{"field": "users.lifecycle", "op": "in", "value": ["New", "Power user"]}` |
| `notIn` | Not in array | `{"field": "users.location", "op": "notIn", "value": ["US", "UK"]}` |
| `includes` | Case-insensitive substring match for social fields only | `{"field": "users.twitter", "op": "includes", "value": "vitalik"}` |
...
<Note>
**Operator compatibility.** The short aliases `eq`, `neq`, `gt`, `gte`, `lt`, `lte`, `nin`, and `contains` are **no longer accepted** and return `400`. Use the canonical operators above. `notEmpty` / `isEmpty` are value-less existence checks (any `value` is ignored) and are supported on string user/profile attributes only — not on numeric metrics (`net_worth_usd`, `volume`, `revenue`, `points`), the `lifecycle` enum, or chain/app/token/label fields.
</Note>
...
{
  "conditions": [
    { "field": "users.volume", "op": "greater", "value": 5000 }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "users.device", "op": "equals", "value": "Mobile" },
    { "field": "users.location", "op": "equals", "value": "US" }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "users.first_utm_source", "op": "equals", "value": "google" },
    { "field": "users.first_utm_medium", "op": "equals", "value": "cpc" }
  ],
  "logic": "and"
}
```
...
- Value matching: use `equals`, `notEquals`, or `includes` (case-insensitive substring) with a non-empty string to match the actual social value.
...
{
  "conditions": [
    { "field": "users.twitter", "op": "includes", "value": "bob" }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "users.email", "op": "equals", "value": "alice@formo.so" }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "chains.balance", "op": "greater", "value": 1000 }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "chains.1.balance", "op": "greater", "value": 5000 }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "chains.1.balance", "op": "greater", "value": 1000 },
    { "field": "chains.137.balance", "op": "greater", "value": 1000 }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "apps.uniswap.balance", "op": "greater", "value": 1000 }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "apps.1.aave.balance", "op": "greater", "value": 500 }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "labels.coinbase.verified_account", "op": "equals", "value": "true" }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "labels.coinbase.verified_country", "op": "equals", "value": "US" }
  ],
  "logic": "and"
}
```
...
{
  "conditions": [
    { "field": "labels.passport.models_aggregate_score", "op": "greaterOrEqual", "value": "50" }
  ],
  "logic": "and"
}
```
...
curl -sS -X GET \
  ...
  -d '{
    "conditions": [
      { "field": "users.net_worth_usd", "op": "greater", "value": 10000 },
      { "field": "users.ens", "op": "notEmpty" },
      { "field": "chains.1.balance", "op": "greater", "value": 0 }
    ],
    "logic": "and"
  }' \
...
curl -sS -X GET \
  ...
  -d '{
    "conditions": [
      { "field": "apps.uniswap.balance", "op": "greater", "value": 0 },
      { "field": "apps.aave.balance", "op": "greater", "value": 0 }
    ],
    "logic": "or"
  }' \
...
curl -sS -X GET \
  ...
  -d '{
    "conditions": [
      ...
      { "field": "users.lifecycle", "op": "equals", "value": "Power user" }
    ],
    "logic": "and"
  }' \
...
curl -sS -X GET \
  ...
  -d '{
    "conditions": [
      { "field": "chains.1.balance", "op": "greater", "value": 10000 },
      { "field": "chains.137.balance", "op": "greater", "value": 5000 },
      { "field": "chains.42161.balance", "op": "greater", "value": 5000 }
    ],
    "logic": "and"
  }' \
