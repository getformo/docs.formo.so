...
Use the [`screen()`](/data/events/screen) method to track screen views - the mobile equivalent of page views:
...
<CardGroup>
  <Card
    title="React Native"
    icon="file-code"
    href="https://github.com/getformo/formo-example-react-native"
  >
    formo-example-react-native
  </Card>
</CardGroup>
