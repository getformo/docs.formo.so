...
<CardGroup>
  ...
  >
    Install Formo in a Next.js app using the app router.
  </Card>
  <Card
  ...
  >
    Install Formo in a Next.js app using the pages router.
  </Card>
  <Card
  ...
  >
    Install Formo in a Farcaster mini app.
  </Card>
</CardGroup>
