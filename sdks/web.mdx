...
- **[Wallet Standard](#solana-wallet-discovery)**: autocaptures wallet `detect`, `connect`, and `disconnect` with any compatible wallet library.
...
Wrap your app with `FormoAnalyticsProvider`. This example uses `@solana/wallet-adapter-react`, but any Wallet Standard-compatible library works:
