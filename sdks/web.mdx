...
Formo offers a few ways to install the SDK:
- [Wagmi](#wagmi) (recommended for apps)
- [HTML Snippet](#html-snippet) for websites
- [React & Next.js (without Wagmi)](#react-nextjs-without-wagmi)

### Wagmi

<Note>
If your app uses [Wagmi](https://wagmi.sh), the Formo SDK can integrate directly for better reliability and security.
</Note>
