...
<CardGroup>
  ...
  <Card
    title="MetaMask SDK"
    icon="file-code"
    href="https://github.com/getformo/formo-example-metamask"
  >
    formo-example-metamask
  </Card>
  <Card
    title="Blocknative"
    icon="file-code"
...
For apps using [Wagmi v2](https://wagmi.sh), enable native integration by providing the Wagmi config and QueryClient:
...
See the full [Solana example app](https://github.com/getformo/formo-example-solana) for a working implementation.
