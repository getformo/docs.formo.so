...
<AccordionGroup>
  ...
  <Accordion title="Why are my Solana wallet connections not showing up?">
    Check that `solana.cluster` matches your chain. If the wallet does not implement Wallet Standard, use the [manual connection fallback](#wallets-without-wallet-standard).
