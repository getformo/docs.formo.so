...
title: 'Web SDK'
icon: browser
description: 'Track key events in websites and web apps with the Formo Web SDK.'
---
...
The [Formo Web SDK](https://github.com/getformo/sdk) is **open source** and implements the standard [Events API](/data/events#events-api).
...
Include the optional `revenue` property to track revenue associated with a user action.
