...
### React with Wagmi (Recommended)

If your app uses [Wagmi](https://wagmi.sh), the Formo SDK can integrate directly with Wagmi's event system for better reliability and performance.
...
<Note>
**Using Wagmi?** Use the [Wagmi integration](#react-with-wagmi-recommended) above instead for better event tracking and compatibility.
</Note>
...
<CardGroup>
  ...
  <Card
    title="Wagmi + RainbowKit example"
    icon="file-code"
    href="https://github.com/getformo/formo-example-wagmi"
  >
    formo-example-wagmi
  </Card>
  <Card
