...
```html HTML snippet
<script src="https://cdn.jsdelivr.net/npm/web-vitals@6/dist/web-vitals.iife.js"></script>
<script>
...
Load the `web-vitals` script before the Formo SDK initializes. With `FormoAnalyticsProvider`, pass it the same way: `options={{ webVitals }}`. Consent and [tracking exclusions](#environments) apply as for other events.
