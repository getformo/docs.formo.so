...
title: "Dune"
sidebarTitle: "Dune"
description: "Request access to the Dune integration for on-chain queries in Formo dashboards and SQL Explorer."
keywords: ["Dune", "Dune Analytics", "on-chain data", "Trino", "DuneSQL", "crypto SQL", "web3 analytics"]
---

<Warning>
  **Request access.** The Dune integration is not generally available. [Contact Formo](https://formo.so/support) to request access for your project. The setup and query instructions below apply only after access is enabled.
</Warning>

Once enabled, connect [Dune](https://dune.com) to query on-chain data (transactions, DEX trades, tokens, and more) directly inside Formo, in the SQL Explorer and in dashboard charts, right next to your first-party analytics.
