...
- **Admin**: Full access to the workspace. Can manage members, roles, and settings but cannot invite admins or delete the workspace or projects.
- **Editor**: Can manage projects, forms, contracts, charts, dashboards, and alerts. Editors cannot manage members, workspace settings, or key project settings.
