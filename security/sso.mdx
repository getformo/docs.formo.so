...
description: "Configure SAML-based Single Sign-On for your Formo organization to centralize team access, enforce identity provider policies, and streamline sign-in."
icon: "key"
---

Single Sign-On (SSO) allows your team members to sign in to Formo using your organization's identity provider, centralizing access management under your existing security policies.
