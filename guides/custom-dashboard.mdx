...
This shows the most common paths users take through your protocol, and which ones lead to transactions.
...
| **Flow (Sankey)** | Common flows | How users navigate your protocol |
