...
- See [How to Build Conversion Funnels](/guides/howto/conversion-funnel) to measure step-by-step conversion
- Use [SQL Explorer](/guides/howto/sql-explorer) to query average time spent in each step
- Set up dashboards to track onboarding KPIs weekly

For conversion tracking, see [How to Build Conversion Funnels](/guides/howto/conversion-funnel).
