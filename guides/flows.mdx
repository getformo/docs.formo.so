...
User flows reveal exactly how people navigate your app after they land. With Formo's flow visualization, you can see where users drop off, which paths convert to transactions, and how to optimize onboarding.
...
Name the chart clearly: "New User Onboarding Flow" or "Post-Swap Flows".
...
<Accordion title="What's the difference between Flows and Funnels?">
