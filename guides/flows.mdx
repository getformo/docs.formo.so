...
- **By Device** (mobile vs desktop drop-off patterns)
...
Example: Compare flows for mobile users vs desktop. If mobile has 40% drop-off at wallet connect but desktop has 10%, your mobile UX needs work.
