...
User flows show how people navigate your app after they land: where they drop off, which paths convert to transactions, and where onboarding needs work.
...
This lets you measure whether each change actually improved onboarding.
