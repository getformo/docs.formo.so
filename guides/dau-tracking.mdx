...
description: 'Measure daily, weekly, and monthly active users for your onchain app with wallet-based analytics. Build DAU, WAU, and MAU dashboards and charts.'
---
...
<Note>For a true rolling 7-day WAU, you'll need a window function. The Ask AI assistant can help generate this query.</Note>
