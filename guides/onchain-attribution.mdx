...
Beyond the built-in tabs, build custom charts to track attribution over time. Use **Ask AI** for quick answers, or the SQL editor for full control. See [Dashboards](/features/product-analytics/charts) for the full guide to creating, organizing, and sharing charts.
