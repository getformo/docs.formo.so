...
Formo supports Google, Meta, Microsoft, TikTok, X, LinkedIn, and Reddit click IDs, plus paid `utm_medium` values without a known click ID. See [Ad attribution](/features/product-analytics/key-metrics#ad-attribution) for the complete parameter list, attribution behavior, and dashboard surfaces.
