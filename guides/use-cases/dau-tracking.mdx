---
title: 'Track DAU for dApps'
description: 'Measure daily, weekly, and monthly active users for your onchain application with wallet-based analytics.'
---

Track daily active users (DAU), weekly active users (WAU), and monthly active users (MAU) for your dApp with Formo's wallet-native analytics.
...
- Understand the difference between visitors and active users for dApps
...
## Part 1: Understanding dApp User Metrics

### Traditional vs. onchain active users

Traditional web analytics count "active users" by sessions or page views. For dApps, this misses the mark:
...
## Part 2: View Built-in DAU Metrics

Formo provides DAU/WAU/MAU metrics out of the box.
...
1. Click **Charts** in the left navigation
2. Click **New Chart**
...
This ratio shows what percentage of monthly users engage daily—a key health metric.

**Using Ask AI:**

Type: "Calculate DAU/MAU ratio for the last 30 days"

A healthy DAU/MAU ratio for dApps:
- **5-10%**: Normal for most dApps
...
View these segments in **Users** > filter by **Lifecycle**.
...
1. **Understand dApp user metrics** (DAU/WAU/MAU with wallet addresses)
2. **View built-in metrics** in the Formo dashboard
...
## Benchmarks for dApp DAU

| dApp Type | Typical DAU/MAU | Notes |
|-----------|-----------------|-------|
