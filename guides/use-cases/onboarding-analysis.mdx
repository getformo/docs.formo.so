...
<Steps>
  <Step title="Go to Flows in the Formo Dashboard" />
  <Step title='Set the Starting event to your landing page (e.g., page = /)' />
  <Step title="Set Steps after to 5-7 steps" />
  <Step title="Filter by New Users to focus on first-time visitors" />
</Steps>
...
<Steps>
  <Step title="Go to Funnels in the dashboard" />
  <Step title="Click Create Funnel" />
  <Step title="Add your onboarding steps in order" />
  <Step title="Set the conversion window (7 days recommended for onboarding)" />
</Steps>
...
<Steps>
  <Step title="Go to Retention in the dashboard" />
  <Step title="Set the Starting event to connect (wallet connection)" />
  <Step title="Set the Returning event to connect (any subsequent connection)" />
  <Step title="View by weekly cohorts" />
</Steps>
...
<Steps>
  <Step title="Note the date of the change" />
  <Step title="Compare funnel metrics before/after" />
  <Step title="Check if retention improved for post-change cohorts" />
</Steps>
...
<Checklist>
  <ChecklistItem>Created onboarding flow from landing page</ChecklistItem>
  <ChecklistItem>Built funnel with key onboarding steps</ChecklistItem>
  <ChecklistItem>Set up retention tracking for new users</ChecklistItem>
  <ChecklistItem>Created segments for each onboarding stage</ChecklistItem>
  <ChecklistItem>Built dashboard with key onboarding metrics</ChecklistItem>
  <ChecklistItem>Set up alerts for onboarding anomalies</ChecklistItem>
</Checklist>
