...
### View attribution in Growth Analytics

1. Go to **Growth Analytics** in the Formo Dashboard
2. See the **Referrers** breakdown
...
Get quick attribution insights with Ask AI:
...
3. **Analyze attribution** in Formo with Growth Analytics
