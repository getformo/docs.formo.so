...
<Steps>
  <Step title="Go to Retention in the Formo Dashboard" />
  <Step title="Set the starting event to connect (wallet connection)" />
  <Step title="View the cohort table" />
</Steps>
...
Track how many users are in each at-risk segment over time.

Use [Ask AI](/features/product-analytics/ai) to generate monitoring charts:
...
Save these charts to a [Dashboard](/features/product-analytics/charts) to monitor segment sizes over time.
...
<Steps>
  ...
  <Step title="Filter by users who are now Churned" />
  <Step title="Set the starting event to their last session" />
  <Step title="Look for patterns in exit behavior" />
</Steps>
...
<Steps>
  <Step title="Go to Users > select your at-risk segment" />
  <Step title="Click Export CSV" />
  <Step title="Download wallet addresses" />
</Steps>
...
<Steps>
  <Step title="Create a segment of users targeted" />
  <Step title="Track how many returned (Resurrected lifecycle)" />
  <Step title="Measure their subsequent retention" />
</Steps>
...
<Checklist>
  <ChecklistItem>Defined what "churned" means for your app</ChecklistItem>
  <ChecklistItem>Calculated baseline churn rate</ChecklistItem>
  <ChecklistItem>Created at-risk user segments</ChecklistItem>
  <ChecklistItem>Set up alerts for high-value user inactivity</ChecklistItem>
  <ChecklistItem>Analyzed churned vs. retained user behavior</ChecklistItem>
  <ChecklistItem>Built churn prevention dashboard</ChecklistItem>
  <ChecklistItem>Established re-engagement workflow</ChecklistItem>
</Checklist>
