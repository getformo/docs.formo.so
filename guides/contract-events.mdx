...
sidebarTitle: "How to Track Contract Events"
...
- See [How to Build Conversion Funnels](/guides/conversion-funnel) to measure onchain conversion
- Learn [SQL Explorer](/guides/sql-explorer) for custom queries
- Check [Ask AI](/guides/ask-ai) to generate queries from natural language

For protocol-specific dashboards, see [How to Build a Protocol Dashboard](/guides/protocol-dashboard).
