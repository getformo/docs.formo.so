...
- **[Create a Conversion Funnel](/guides/conversion-funnel)**: High retention is good, but you need high conversion first.
...
- **[Build a Protocol Dashboard](/guides/protocol-dashboard)**: Track retention alongside other key metrics in one view.
