...
<Step>
**Understand the why** (Week 2): Use Ask AI: "Why are mobile users churning faster?" Discover: mobile users have 3x higher transaction failures due to a timeout issue.
</Step>
