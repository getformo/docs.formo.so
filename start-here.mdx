...
[Formo](https://formo.so) is a web3 data platform that helps you understand your users and how they engage with your app so you can build a better product. [Learn why it's important.](https://formo.so/blog/actionable-insights-for-onchain-apps).
