...
[Formo](https://formo.so) is a web3 data platform that helps you understand your users and how they engage with your app so you can build a better product. [Learn why we're building this](https://formo.so/about).
