...
description: 'Reference for the transaction event, including status tracking for started, broadcasted, confirmed, and rejected wallet transactions with chain and hash data.'
---
