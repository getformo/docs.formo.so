...
description: 'Reference for the identify event that ties users to their actions and records traits like wallet name and RDNS for cross-session user recognition.'
---
