...
| Property | Type | Description |
|:---------|:-----|:------------|
| `idempotency_key` | String or Number | A stable identifier for one action, such as an order ID. The key is hashed into the message ID and is not sent as a property. |
