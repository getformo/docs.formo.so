...
icon: cubes-stacked
description: 'Understand exactly what data the Formo SDK collects, how it flows through the system, and how privacy is maintained with no cookies or fingerprinting.'
---
...
Ad platforms append a click identifier to your landing page URL when a user clicks an ad. We capture these parameters to attribute traffic and users to the acquiring ad network (see [Ad attribution](/features/product-analytics/key-metrics#ad-attribution)):
