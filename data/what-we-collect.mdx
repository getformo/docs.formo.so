...
Ad platforms append a click identifier to your landing page URL when a user clicks an ad. We capture these parameters to attribute traffic and users to the acquiring ad network (see [Ad attribution](/features/attribution/ads)):
