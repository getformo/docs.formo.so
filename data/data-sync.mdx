...
title: 'Data sync'
icon: upload
description: 'Configure data pipelines to export events, users, wallet profiles, and query results to Google Cloud Storage or Amazon S3 on a schedule or on-demand.'
---

Set up a pipeline to export data to one of the destinations below, on a schedule or on-demand.
...
- **Segments:** Filtered user cohorts based on lifecycle, behavior, or custom filters.
