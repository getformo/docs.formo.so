...
Query data with the [Analytics API](/api/overview#analytics-api) and [Profiles API](/api/overview#profiles-api), explore with the [BI integration](/data/bi), export with [Data sync](/data/data-sync), or write SQL directly in the [Explorer](/features/product-analytics/explore).
...
<CardGroup cols={2}>
  ...
  <Card title="Analytics API" icon="code" href="/api/query">
