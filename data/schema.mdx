...
title: Data schema
icon: database
description: Full data schema reference for the Formo data warehouse. Query events, users, sessions, revenue, wallet profiles, and more using ClickHouse SQL in the Explorer.
---
...
| `context` | String | JSON metadata: user_agent, page info, referrer |
| `properties` | String | JSON with event-specific custom properties |
