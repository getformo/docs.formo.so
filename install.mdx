...
Ensure you pass a valid `apiKey` when initializing the SDK.

#### SDK Not Initialized

If you encounter issues with initialization, check the console logs for errors and ensure the project ID and API key are correct. 

To test the script, navigate to your website and open the network tab of the developer tools in your browser (usually F12 or Ctrl/Command + Shift + I). Search for 'events' and make sure you get a 200 response code in the status column.

#### Network Errors

Verify that the analytics service URL is accessible from your network.

## Support & Feedback

<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.com/invite/GNwtNPBeTJ">
  ...
  <Card title="Founder" icon="comments" href="mailto:yos@formo.so">
    Bug him at [yos@formo.so](mailto:yos@formo.so) (tell me anything that’s on your mind - the good and the bad).
  </Card>
</CardGroup>