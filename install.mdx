---
title: "Install Formo"
description: "Step-by-step guide to installing the Formo SDK on your website and app."
icon: rocket-launch
---

<Info>For best results, install Formo on both your website (example.com) and your app (app.example.com) using the same project / write key.</Info>
