...
<Accordion title="Copy prompt">
  ...
  **Choose the right method based on the project:**
  ...
  If the project is a Solana app, **always** use Option E. Track signatures explicitly, and transactions unless a framework-kit store records them.
...
<Tabs>
  ...
  <Tab icon="circle-nodes" title="Solana">
    ...
    We recommend framework-kit for the fullest autocapture. Other compatible wallet libraries get `detect`, `connect`, and `disconnect` through [Wallet Standard](https://github.com/wallet-standard/wallet-standard).
    ...
    <AccordionGroup>
      ...
      <Accordion title="Other Wallet Standard libraries">
      ...
      <Accordion title="Wallet without Wallet Standard">
    ...
    Track [signatures](/data/events/signature) explicitly, and [transactions](/data/events/transaction) unless a framework-kit store records them. Use [`track`](/sdks/web#track-events) for app-specific actions.
