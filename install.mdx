...
<AccordionGroup>
  ...
  <Accordion title="How do I verify that the Formo SDK is installed correctly?">
    After installing, visit your site and open [Live View](/features/product-analytics/live-view) in the Formo dashboard. You should see your pageview appear in real-time. You can also check your browser's Network tab for requests to `api.formo.so`.
  </Accordion>
