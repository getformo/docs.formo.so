...
sidebarTitle: "Charts"
icon: chart-line
description: "Create, list, update, and delete charts within dashboard boards using the Formo CLI. Charts are scoped to a specific board and support multiple types."
---
