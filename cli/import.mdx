...
sidebarTitle: "Import"
icon: file-import
description: "Bulk import wallet addresses into your Formo project from a CSV file or stdin using the CLI. Imported wallets are automatically enriched with onchain data."
---
