...
| `formo alerts` | List, get, create, update, toggle, and delete project alerts |
| `formo contracts` | List, get, create, update, and delete tracked contracts (pipeline inclusion via `update --include-in-pipeline`) |
