...
You can use the Profiles API for real-time personalization. Once you fetch a profile, you can use them in your app in real-time. You can respond immediately with triggered, user-focused messaging based on actions like page views or app clicks and provide a better customer experience.
...
<CardGroup cols={2}>
  ...
  <Card title="Founder" icon="comments" href="mailto:yos@formo.so">
    Bug him at [yos@formo.so](mailto:yos@formo.so) (share anything that’s on your mind - good and bad)
  </Card>
</CardGroup>