...
description: "Search and filter wallet profiles with advanced filtering by labels, net worth, chain activity, and more. Returns paginated results with full profile data."
