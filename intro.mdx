...
Understand your users, where they come from, and what they do so you can build a better app. Save time and money from having to manage your own data pipelines and infrastructure. 
...
<Steps>
  ...
  <Step title="Install Formo">
    [Install Formo](/install). The Formo SDK supports HTML, React, and Next.js.
  </Step>
  <Step title="Success!">
