...
**Formo makes analytics easy.** Get the best of web, product, and onchain analytics on one versatile platform.
Accelerate your growth loop with unified analytics and attribution.

<Frame caption = "Save time and money from having to manage your own data pipelines and infrastructure. ">
  <img src="/images/intro1.png" alt="Formo" />
</Frame>

Understand your users, where they come from, and what they do so you can build a better app. No third-party cookies, no personal data. Just clear, privacy-friendly insights.
