...
[Formo](https://formo.so) is the data platform for onchain apps. 
...
Understand your users, where they come from, and what they do so you can build a better app. Accelerate your growth loop with unified analytics and attribution.
...
<Steps>
  <Step title="Create a workspace">
    ...
    If you have multiple subdomains such as `yourdomain.com` and `app.yourdomain.com`, simply add your main domain name (`yourdomain.com`) and use the same tracking snippet for all subdomains.
  </Step>
  <Step title="Install Formo">
    [Install Formo](/install) on your website and app. Formo supports HTML, React, and Next.js.
  </Step>
  <Step title="Success!">
